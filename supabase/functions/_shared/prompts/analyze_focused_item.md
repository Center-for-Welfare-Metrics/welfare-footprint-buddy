...
```json
{
  ...
  "isFood": boolean,
  "animalIngredients": { "value": "string", "confidence": "High" | "Medium" | "Low" },
  "productionSystem": { "value": "string", "confidence": "High" | "Medium" | "Low", "assumption": "string (optional)" },
  "welfareConcerns": { "value": "string", "confidence": "High" | "Medium" | "Low" },
  "brand": "string | null",
