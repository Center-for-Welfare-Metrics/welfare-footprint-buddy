...
const PROMPT_VERSIONS: Record<string, string> = {
  ...
  suggest_ethical_swap: 'v3.4',
  enrich_description: 'v1.0',
...
\`\`\``,
  ...
  enrich_description: `You are a food description enrichment expert. Your task is to transform brief user inputs into informative, natural-language summaries.
