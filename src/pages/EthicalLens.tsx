...
const EthicalLens = () => {
  ...
  const handleContinue = () => {
    // Navigate back to results with the selected lens
    navigate('/', { 
      state: { 
        selectedLens,
        analysisData: passedState?.analysisData,
        imageData: passedState?.imageData,
        fromEthicalLensPage: true
      }
    });
  };
    ...
    <NavigationWrapper onBack={handleBack}>
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-gray-950 p-4 pb-48">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Continue Button */}
          <div className="fixed bottom-0 left-0 right-0 p-4 pb-8 bg-gradient-to-t from-gray-900 via-gray-900 to-transparent">
            <div className="max-w-2xl mx-auto">
              <Button
